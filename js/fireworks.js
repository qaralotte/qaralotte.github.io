...
function createParticule(e,t){
  var a={};
  return a.x=e,a.y=t,a.color=colors[anime.random(0,colors.length-1)],a.radius=anime.random(8,10),a.endPos=setParticuleDirection(a),a.draw=function(){
...
function animateParticules(e,t){
  ...
  anime.timeline().add({
    ...
    targets:a,radius:anime.random(80,100),lineWidth:0,alpha:{
...
if(canvasEl){
  var ctx=canvasEl.getContext("2d"),numberOfParticules=15,pointerX=0,pointerY=0,tap="mousedown",colors=["#FF1461","#18FF92","#5A87FF","#FBF38C"],setCanvasSize=debounce(function(){
